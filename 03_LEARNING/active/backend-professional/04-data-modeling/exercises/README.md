...
1. Explica con un diagrama cómo se relacionan los conceptos de entities, relationships, PK, FK, UNIQUE, CHECK, NOT NULL, normalization, denormalization, integridad, schema evolution y Flyway.
...
7. Implementa la fase de modelado y migraciones del laboratorio **LAB-BACKEND-004-postgresql-model-and-query-plan** y registra resultado esperado frente a resultado real.
