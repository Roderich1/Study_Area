...
1. Explica con un diagrama cómo se relacionan los conceptos de JOIN, GROUP BY, subqueries, CTE, EXPLAIN, EXPLAIN ANALYZE, B-tree, índices compuestos, parciales y covering, selectivity, cardinality y trade-offs.
