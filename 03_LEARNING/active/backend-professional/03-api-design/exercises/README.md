...
1. Explica con un diagrama cómo se relacionan los conceptos de resource modeling, URI design, DTOs, contratos, validación, Problem Details, paginación, cursor pagination, filtering, sorting, versioning, OpenAPI y backward compatibility.
...
7. Implementa el escenario mínimo del laboratorio **LAB-BACKEND-003-api-error-contract** y registra resultado esperado frente a resultado real.
