...
1. Explica con un diagrama cómo se relacionan los conceptos de cliente-servidor, DNS, TCP, TLS, HTTP, puertos, reverse proxy, application server, threads/processes, ciclo de conexión, ciclo de request, base de datos y statelessness.
...
7. Implementa el escenario mínimo del laboratorio **LAB-BACKEND-001-request-lifecycle** y registra resultado esperado frente a resultado real.
