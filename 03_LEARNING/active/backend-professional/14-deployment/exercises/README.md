...
1. Explica con un diagrama cómo se relacionan los conceptos de Dockerfile, multi-stage builds, images, containers, Compose, environment variables, configuration, secrets, healthchecks, readiness, liveness, reverse proxy, TLS, deployment y rollback.
...
7. Implementa el escenario mínimo del laboratorio **LAB-BACKEND-014-containerized-stack** y registra resultado esperado frente a resultado real.
