# Preguntas de recuperación — Sesión 02

## Fundamentales

- Explica el flujo completo de **HTTP Semantics** sin usar definiciones memorizadas.
...
- Diseña una respuesta defendible para un caso de producción relacionado con **HTTP Semantics**.
