...
1. Explica con un diagrama cómo se relacionan los conceptos de synchronous/asynchronous processing, queues, events, workers, at-most-once, at-least-once, duplicate delivery, eventual consistency, transactional outbox y dead-letter queues.
...
7. Implementa el escenario mínimo del laboratorio **LAB-BACKEND-013-transactional-outbox** y registra resultado esperado frente a resultado real.
