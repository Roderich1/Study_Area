...
Separar identidad, autenticación y autorización al proteger recursos de una API.

## Por qué importa en producción

proteger endpoints del proyecto con un modelo de identidad y permisos explícito. Un backend profesional debe hacer explícitos sus límites, fallos y costes; una implementación que funciona una vez no demuestra comportamiento seguro bajo carga, concurrencia o evolución.
...
authentication, authorization, sessions, cookies, access/refresh tokens, JWT, OAuth, OpenID Connect, issuer, audience, scopes, roles, permissions, Resource Server y Authorization Server.
...
**LAB-BACKEND-008-bola-authorization** — proteger endpoints del proyecto con un modelo de identidad y permisos explícito. La planificación y el contrato del laboratorio están en [04_LABS/backend/LAB_INDEX.md](../../../../04_LABS/backend/LAB_INDEX.md).
...
[Spring Security](https://docs.spring.io/spring-security/reference/) y [OpenID Connect](https://openid.net/developers/how-connect-works/). Mantener la lista curada en [09_RESOURCES/backend-resources.md](../../../../09_RESOURCES/backend-resources.md).
...
Después de estudiar y verificar, podrían promoverse explicaciones refinadas sobre authentication, authorization, sessions, cookies, access/refresh tokens, JWT, OAuth, OpenID Connect, issuer, audience, scopes, roles, permissions, Resource Server y Authorization Server, separadas de los apuntes crudos. Este módulo no afirma que ese conocimiento ya esté consolidado.
