...
1. Explica con un diagrama cómo se relacionan los conceptos de authentication, authorization, sessions, cookies, access/refresh tokens, JWT, OAuth, OpenID Connect, issuer, audience, scopes, roles, permissions, Resource Server y Authorization Server.
