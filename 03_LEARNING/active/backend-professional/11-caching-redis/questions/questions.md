# Preguntas de recuperación — Sesión 11

## Fundamentales

- Explica el flujo completo de **Redis & Caching** sin usar definiciones memorizadas.
...
- Diseña una respuesta defendible para un caso de producción relacionado con **Redis & Caching**.
