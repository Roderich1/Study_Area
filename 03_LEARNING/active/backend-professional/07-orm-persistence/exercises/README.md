...
1. Explica con un diagrama cómo se relacionan los conceptos de ORM, JPA/Hibernate, entity lifecycle, persistence context, transactions, lazy/eager loading, N+1, batching, optimistic locking y connection pools.
...
7. Implementa el escenario mínimo del laboratorio **LAB-BACKEND-007-jpa-n-plus-one** y registra resultado esperado frente a resultado real.
